        ...
        {!isCollapsed ? (
          <div className="space-y-3">
            ...
            <div className="space-y-1.5">
              <label className="text-[8px] font-extrabold text-zinc-500 uppercase tracking-widest block px-1">
                Técnico Activo
              </label>
              <select
              ...
              >
                {operators.map(op => (
                  <option key={op.id} value={op.id} className="bg-zinc-950 text-zinc-300 font-semibold">{op.name}</option>
                ))}
              </select>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2 items-center">
            <img
              ...
              title={`${activeOperator.name} (${activeOperator.role})`}
            />
          </div>
        )}
      </div>
